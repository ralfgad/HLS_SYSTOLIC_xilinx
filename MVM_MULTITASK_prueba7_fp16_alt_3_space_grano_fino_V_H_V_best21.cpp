...
//las versiones 22 23 y 24 son para reducir el tama�o para intentar meterlo en una de1soc
...
#if noper==3
#include "Mis_tasks_mejora_grano_fino_V_H_V_best21_half_reducido2.h"
#endif
...
ihc::launch<MiSistema::producerb1_idea2_par>(&bb1, MM, NN);
ihc::launch<MiSistema::producera_idea2_par>(&aa,NN);
