...
public:
	...
	using a_0= ihc::pipe<class TaskPipeID<10>, T_oper, 1>;
	using a_1 = ihc::pipe<class TaskPipeID<11>, T_oper, 1>;
	using a_2 = ihc::pipe<class TaskPipeID<12>, T_oper, 1>;
/*
	using a_3 = ihc::pipe<class TaskPipeID<13>, T_oper, 1>;
	using a_4 = ihc::pipe<class TaskPipeID<14>, T_oper, 1>;
	using a_5 = ihc::pipe<class TaskPipeID<15>, T_oper, 1>;
	using a_6 = ihc::pipe<class TaskPipeID<16>, T_oper, 1>;
	*/
	using a_7 = ihc::pipe<class TaskPipeID<17>, T_oper, 1>;
	...
	using b1_0 = ihc::pipe<class TaskPipeID<20>, T_oper, semigenial_v>;
	using b1_1 = ihc::pipe<class TaskPipeID<21>, T_oper, semigenial_v>;
	using b1_2 = ihc::pipe<class TaskPipeID<22>, T_oper, semigenial_v>;
/*
	using b1_3 = ihc::pipe<class TaskPipeID<23>, T_oper, semigenial_v>;
	using b1_4 = ihc::pipe<class TaskPipeID<24>, T_oper, semigenial_v>;
	using b1_5 = ihc::pipe<class TaskPipeID<25>, T_oper, semigenial_v>;
	using b1_6 = ihc::pipe<class TaskPipeID<26>, T_oper, semigenial_v>;
	*/
	using b1_7 = ihc::pipe<class TaskPipeID<27>, T_oper, semigenial_v>;
	...
	*/
	...
	using layer1_0 = ihc::pipe<class TaskPipeID<30>, int, semigenial_v>;
	using layer1_1 = ihc::pipe<class TaskPipeID<31>, int, semigenial_v>;
	using layer1_2 = ihc::pipe<class TaskPipeID<32>, int, semigenial_v>;
/*
...
*/
	using layer1_6 = ihc::pipe<class TaskPipeID<36>, int, semigenial_v>;

	using layer1_7 = ihc::pipe<class TaskPipeID<37>, int, semigenial_v>;
...
/*
	...
	*/
	...
	using layer3_0 = ihc::pipe<class TaskPipeID<80>, int, semigenial>;
	using layer3_1 = ihc::pipe<class TaskPipeID<81>, int, semigenial>;
	using layer3_2 = ihc::pipe<class TaskPipeID<82>, int, semigenial>;
/*
	...
	*/
	using layer3_6 = ihc::pipe<class TaskPipeID<86>, int, semigenial>;

	using layer3_7 = ihc::pipe<class TaskPipeID<87>, int, semigenial>;
...
*/
	...
	typedef ihc::mm_host<T_com, ihc::aspace<1>, ihc::dwidth<128>, ihc::awidth<32>, ihc::waitrequest<true>, ihc::latency<0>  > ACTIVACIONIN;
	typedef ihc::mm_host<T_com, ihc::aspace<2>, ihc::dwidth<128>, ihc::awidth<32>, ihc::waitrequest<true>, ihc::latency<0> > PESO1;
	typedef ihc::mm_host<T_com, ihc::aspace<4>, ihc::dwidth<128>, ihc::awidth<32>, ihc::waitrequest<true>, ihc::latency<0> > PESO2;
	typedef ihc::mm_host<T_com, ihc::aspace<5>, ihc::dwidth<128>, ihc::awidth<32>, ihc::waitrequest<true>, ihc::latency<0> > PESO3;
...
#pragma max_interleaving 0
	...
	static void PE_v0()
	{
		...
		while (1)
		{
			...
			resultado = my_ffplusf_cyv_half_prueba(operando1, peso, operando2);
    ...
    static void PE_v7()
	{
		...
		while (1)
		{
			...
			if (ultimo_BLOCK_SIZE == true) {
				temp2 = my_tanhfp16_prueba(resultado);
				//layer1_layer2::write(temp2);
				layer1_layer2.write(temp2);
			}
