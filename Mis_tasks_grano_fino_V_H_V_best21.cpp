...
public:
	...
	using a_0= ihc::pipe<class TaskPipeID<10>, uint64_t, 1>;
	using a_1 = ihc::pipe<class TaskPipeID<11>, uint64_t, 1>;
	using a_2 = ihc::pipe<class TaskPipeID<12>, uint64_t, 1>;
	using a_3 = ihc::pipe<class TaskPipeID<13>, uint64_t, 1>;
	using a_4 = ihc::pipe<class TaskPipeID<14>, uint64_t, 1>;
	using a_5 = ihc::pipe<class TaskPipeID<15>, uint64_t, 1>;
	using a_6 = ihc::pipe<class TaskPipeID<16>, uint64_t, 1>;
	using a_7 = ihc::pipe<class TaskPipeID<17>, uint64_t, 1>;
	...
	using b1_0 = ihc::pipe<class TaskPipeID<20>, uint64_t, semigenial_v>;
	using b1_1 = ihc::pipe<class TaskPipeID<21>, uint64_t, semigenial_v>;
	using b1_2 = ihc::pipe<class TaskPipeID<22>, uint64_t, semigenial_v>;
	using b1_3 = ihc::pipe<class TaskPipeID<23>, uint64_t, semigenial_v>;
	using b1_4 = ihc::pipe<class TaskPipeID<24>, uint64_t, semigenial_v>;
	using b1_5 = ihc::pipe<class TaskPipeID<25>, uint64_t, semigenial_v>;
	using b1_6 = ihc::pipe<class TaskPipeID<26>, uint64_t, semigenial_v>;
	using b1_7 = ihc::pipe<class TaskPipeID<27>, uint64_t, semigenial_v>;
...
#ifdef con_dsp
			resultado = my_ffplusf_2_cyv(operando1, peso.fv[0], operando2.fv[0], peso.fv[1], operando2.fv[1]);
#else
	...
	static void PE_h0()
	{
		...
		while (1)
		{
			...
			*/
			...
			acumulado = my_ffaccf_cyv(principio, operando2,peso);
#else
			acumulado = operando2 * peso + acumulado;
#endif
...
#ifdef con_dsp
			resultado = my_ffplusf_cyv(operando1, peso, operando2);
#else
