...
// ==============================================================
`timescale 1ns/1ps
module MVM_opcion7_super_mejorada_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_OUTPUT_R_DATA_0 = 7'h28,
    ADDR_OUTPUT_R_DATA_1 = 7'h2c,
    ADDR_OUTPUT_R_CTRL   = 7'h30,
    ADDR_MM_DATA_0       = 7'h34,
    ADDR_MM_CTRL         = 7'h38,
    ADDR_NN_DATA_0       = 7'h3c,
    ADDR_NN_CTRL         = 7'h40,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NN_DATA_0)
            int_NN[31:0] <= (WDATA[31:0] & wmask) | (int_NN[31:0] & ~wmask);
    end
end
