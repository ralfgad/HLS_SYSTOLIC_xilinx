...
`define AUTOTB_DUT      MVM_opcion7_super_mejorada
`define AUTOTB_DUT_INST AESL_inst_MVM_opcion7_super_mejorada
`define AUTOTB_TOP      apatb_MVM_opcion7_super_mejorada_top
`define AUTOTB_LAT_RESULT_FILE "MVM_opcion7_super_mejorada.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "MVM_opcion7_super_mejorada.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_MVM_opcion7_super_mejorada_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_input1 1
`define AESL_DEPTH_input2 1
`define AESL_DEPTH_output_r 1
`define AESL_DEPTH_MM 1
`define AESL_DEPTH_NN 1
`define AUTOTB_TVIN_gmem  "./c.MVM_opcion7_super_mejorada.autotvin_gmem.dat"
`define AUTOTB_TVIN_input1  "./c.MVM_opcion7_super_mejorada.autotvin_input1.dat"
`define AUTOTB_TVIN_input2  "./c.MVM_opcion7_super_mejorada.autotvin_input2.dat"
`define AUTOTB_TVIN_output_r  "./c.MVM_opcion7_super_mejorada.autotvin_output_r.dat"
`define AUTOTB_TVIN_MM  "./c.MVM_opcion7_super_mejorada.autotvin_MM.dat"
`define AUTOTB_TVIN_NN  "./c.MVM_opcion7_super_mejorada.autotvin_NN.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_gmem.dat"
`define AUTOTB_TVIN_input1_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_input1.dat"
`define AUTOTB_TVIN_input2_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_input2.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_output_r.dat"
`define AUTOTB_TVIN_MM_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_MM.dat"
`define AUTOTB_TVIN_NN_out_wrapc  "./rtl.MVM_opcion7_super_mejorada.autotvin_NN.dat"
`define AUTOTB_TVOUT_gmem  "./c.MVM_opcion7_super_mejorada.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.MVM_opcion7_super_mejorada.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem = 2144;
parameter LENGTH_input1 = 1;
parameter LENGTH_input2 = 1;
parameter LENGTH_output_r = 1;
parameter LENGTH_MM = 1;
parameter LENGTH_NN = 1;
...
reg end_input1;
reg [31:0] size_input1;
reg [31:0] size_input1_backup;
reg end_input2;
reg [31:0] size_input2;
reg [31:0] size_input2_backup;
reg end_output_r;
