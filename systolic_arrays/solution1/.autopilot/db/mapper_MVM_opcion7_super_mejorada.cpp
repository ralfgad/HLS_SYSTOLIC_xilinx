...
extern "C" void MVM_opcion7_super_mejorada(int*, int, int, int, int, int);
extern "C" void apatb_MVM_opcion7_super_mejorada_hw(volatile void * __xlx_apatb_param_input1, volatile void * __xlx_apatb_param_input2, volatile void * __xlx_apatb_param_output, int __xlx_apatb_param_MM, int __xlx_apatb_param_NN) {
  ...
  int __xlx_size_param_input1 = 64;
  ...
  int __xlx_size_param_input2 = 2048;
  int __xlx_offset_param_input2 = 64;
  int __xlx_offset_byte_param_input2 = 64*4;
  for (int j = 0, e = 32; j != e; ++j) {
    __xlx_input1_input2_output__tmp_vec.push_back(((int*)__xlx_apatb_param_output)[j]);
  }
  int __xlx_size_param_output = 32;
  int __xlx_offset_param_output = 2112;
  int __xlx_offset_byte_param_output = 2112*4;
  ...
  // DUT call
  MVM_opcion7_super_mejorada(__xlx_input1_input2_output__input_buffer, __xlx_offset_byte_param_input1, __xlx_offset_byte_param_input2, __xlx_offset_byte_param_output, __xlx_apatb_param_MM, __xlx_apatb_param_NN);
