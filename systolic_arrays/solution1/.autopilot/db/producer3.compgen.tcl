...
set id 1
set name MVM_opcion7_super_mejorada_mul_32ns_32ns_64_2_1
...
set id 2
set name MVM_opcion7_super_mejorada_mul_32ns_32ns_62_2_1
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_aa \
    op interface \
    ports { aa_din { O 32 vector } aa_full_n { I 1 bit } aa_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_bb1 \
    op interface \
    ports { bb1_din { O 32 vector } bb1_full_n { I 1 bit } bb1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ORIGEN_out \
    op interface \
    ports { ORIGEN_out_din { O 32 vector } ORIGEN_out_full_n { I 1 bit } ORIGEN_out_write { O 1 bit } } \
} "
}
