...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ss \
    op interface \
    ports { ss_dout { I 32 vector } ss_empty_n { I 1 bit } ss_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_activacion \
    op interface \
    ports { activacion_dout { I 64 vector } activacion_empty_n { I 1 bit } activacion_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_DESTINO \
    op interface \
    ports { DESTINO_dout { I 32 vector } DESTINO_empty_n { I 1 bit } DESTINO_read { O 1 bit } } \
} "
}
