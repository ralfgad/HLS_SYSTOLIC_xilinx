...
set id 16
set name MVM_opcion7_super_mejorada_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 17
set name MVM_opcion7_super_mejorada_fmul_32ns_32ns_32_4_max_dsp_1
...
set id 18
set name MVM_opcion7_super_mejorada_fptrunc_64ns_32_2_no_dsp_1
...
set id 19
set name MVM_opcion7_super_mejorada_fpext_32ns_64_2_no_dsp_1
...
set id 20
set name MVM_opcion7_super_mejorada_dsub_64ns_64ns_64_7_full_dsp_1
...
set id 21
set name MVM_opcion7_super_mejorada_dadd_64ns_64ns_64_7_full_dsp_1
...
set id 22
set name MVM_opcion7_super_mejorada_ddiv_64ns_64ns_64_59_no_dsp_1
...
set id 23
set name MVM_opcion7_super_mejorada_dexp_64ns_64ns_64_21_full_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_aa \
    op interface \
    ports { aa_dout { I 32 vector } aa_empty_n { I 1 bit } aa_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_bb1 \
    op interface \
    ports { bb1_dout { I 32 vector } bb1_empty_n { I 1 bit } bb1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ss \
    op interface \
    ports { ss_din { O 32 vector } ss_full_n { I 1 bit } ss_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ORIGEN \
    op interface \
    ports { ORIGEN_dout { I 32 vector } ORIGEN_empty_n { I 1 bit } ORIGEN_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_DESTINO_out \
    op interface \
    ports { DESTINO_out_din { O 32 vector } DESTINO_out_full_n { I 1 bit } DESTINO_out_write { O 1 bit } } \
} "
}
