...
set C_modelName {producer3}
set C_modelType { void 0 }
set C_modelArgList {
	{ aa int 32 regular {fifo 1 volatile }  }
	{ bb1 int 32 regular {fifo 1 volatile }  }
	{ gmem int 32 regular {axi_master 0}  }
	{ activacion int 64 regular  }
	{ weight int 64 regular  }
	{ DESTINO int 32 regular  }
	{ ORIGEN int 32 regular  }
	{ output_r int 64 regular  }
	{ DESTINO_out int 32 regular {fifo 1}  }
	{ ORIGEN_out int 32 regular {fifo 1}  }
	{ output_out int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "aa", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bb1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "activacion", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "weight", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "DESTINO", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "ORIGEN", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ORIGEN_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ aa_din sc_out sc_lv 32 signal 0 } 
	{ aa_full_n sc_in sc_logic 1 signal 0 } 
	{ aa_write sc_out sc_logic 1 signal 0 } 
	{ bb1_din sc_out sc_lv 32 signal 1 } 
	{ bb1_full_n sc_in sc_logic 1 signal 1 } 
	{ bb1_write sc_out sc_logic 1 signal 1 } 
	...
	{ activacion sc_in sc_lv 64 signal 3 } 
	{ weight sc_in sc_lv 64 signal 4 } 
	{ DESTINO sc_in sc_lv 32 signal 5 } 
	{ ORIGEN sc_in sc_lv 32 signal 6 } 
	{ output_r sc_in sc_lv 64 signal 7 } 
	{ DESTINO_out_din sc_out sc_lv 32 signal 8 } 
	{ DESTINO_out_full_n sc_in sc_logic 1 signal 8 } 
	{ DESTINO_out_write sc_out sc_logic 1 signal 8 } 
	{ ORIGEN_out_din sc_out sc_lv 32 signal 9 } 
	{ ORIGEN_out_full_n sc_in sc_logic 1 signal 9 } 
	{ ORIGEN_out_write sc_out sc_logic 1 signal 9 } 
	{ output_out_din sc_out sc_lv 64 signal 10 } 
	{ output_out_full_n sc_in sc_logic 1 signal 10 } 
	{ output_out_write sc_out sc_logic 1 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "aa_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "aa", "role": "din" }} , 
 	{ "name": "aa_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "aa", "role": "full_n" }} , 
 	{ "name": "aa_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "aa", "role": "write" }} , 
 	{ "name": "bb1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "bb1", "role": "din" }} , 
 	{ "name": "bb1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bb1", "role": "full_n" }} , 
 	{ "name": "bb1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bb1", "role": "write" }} , 
 	...
 	{ "name": "activacion", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "activacion", "role": "default" }} , 
 	{ "name": "weight", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "weight", "role": "default" }} , 
 	{ "name": "DESTINO", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "DESTINO", "role": "default" }} , 
 	{ "name": "ORIGEN", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ORIGEN", "role": "default" }} , 
 	...
 	{ "name": "ORIGEN_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ORIGEN_out", "role": "din" }} , 
 	{ "name": "ORIGEN_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ORIGEN_out", "role": "full_n" }} , 
 	{ "name": "ORIGEN_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ORIGEN_out", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "aa", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "aa_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "bb1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "ORIGEN_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_62_2_1_U2", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	aa { ap_fifo {  { aa_din fifo_data 1 32 }  { aa_full_n fifo_status 0 1 }  { aa_write fifo_update 1 1 } } }
	bb1 { ap_fifo {  { bb1_din fifo_data 1 32 }  { bb1_full_n fifo_status 0 1 }  { bb1_write fifo_update 1 1 } } }
	...
	activacion { ap_none {  { activacion in_data 0 64 } } }
	weight { ap_none {  { weight in_data 0 64 } } }
	DESTINO { ap_none {  { DESTINO in_data 0 32 } } }
	ORIGEN { ap_none {  { ORIGEN in_data 0 32 } } }
	...
	ORIGEN_out { ap_fifo {  { ORIGEN_out_din fifo_data 1 32 }  { ORIGEN_out_full_n fifo_status 0 1 }  { ORIGEN_out_write fifo_update 1 1 } } }
