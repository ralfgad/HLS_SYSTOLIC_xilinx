...
if {[file isfile MVM_opcion7_super_mejorada.autotvin.dat]} {
	file delete -force MVM_opcion7_super_mejorada.autotvin.dat
}

if {[file isfile MVM_opcion7_super_mejorada.autotvout.dat]} {
	file delete -force MVM_opcion7_super_mejorada.autotvout.dat
}
