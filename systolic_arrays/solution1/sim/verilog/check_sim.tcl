...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.MVM_opcion7_super_mejorada.autotvin_gmem.dat"
         "c.MVM_opcion7_super_mejorada.autotvin_input1.dat"
         "c.MVM_opcion7_super_mejorada.autotvin_input2.dat"
         "c.MVM_opcion7_super_mejorada.autotvin_output_r.dat"
         "c.MVM_opcion7_super_mejorada.autotvin_MM.dat"
         "c.MVM_opcion7_super_mejorada.autotvin_NN.dat"
         "c.MVM_opcion7_super_mejorada.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.MVM_opcion7_super_mejorada.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
