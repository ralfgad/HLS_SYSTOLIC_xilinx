...
entity MVM_opcion7_super_mejorada_control_s_axi is
generic (
...
end entity MVM_opcion7_super_mejorada_control_s_axi;
...
architecture behave of MVM_opcion7_super_mejorada_control_s_axi is
    ...
    constant ADDR_INPUT1_DATA_0   : INTEGER := 16#10#;
    constant ADDR_INPUT1_DATA_1   : INTEGER := 16#14#;
    constant ADDR_INPUT1_CTRL     : INTEGER := 16#18#;
    constant ADDR_INPUT2_DATA_0   : INTEGER := 16#1c#;
    constant ADDR_INPUT2_DATA_1   : INTEGER := 16#20#;
    constant ADDR_INPUT2_CTRL     : INTEGER := 16#24#;
    ...
    constant ADDR_MM_DATA_0       : INTEGER := 16#34#;
    constant ADDR_MM_CTRL         : INTEGER := 16#38#;
    constant ADDR_NN_DATA_0       : INTEGER := 16#3c#;
    constant ADDR_NN_CTRL         : INTEGER := 16#40#;
    ...
    signal int_input1          : UNSIGNED(63 downto 0) := (others => '0');
    signal int_input2          : UNSIGNED(63 downto 0) := (others => '0');
    signal int_output_r        : UNSIGNED(63 downto 0) := (others => '0');
    signal int_MM              : UNSIGNED(31 downto 0) := (others => '0');
    signal int_NN              : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_INPUT1_DATA_1 =>
                        rdata_data <= RESIZE(int_input1(63 downto 32), 32);
                    when ADDR_INPUT2_DATA_0 =>
                        rdata_data <= RESIZE(int_input2(31 downto 0), 32);
                    when ADDR_INPUT2_DATA_1 =>
                        rdata_data <= RESIZE(int_input2(63 downto 32), 32);
                    ...
                    when ADDR_NN_DATA_0 =>
                        rdata_data <= RESIZE(int_NN(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT1_DATA_1) then
                    int_input1(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_input1(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT2_DATA_1) then
                    int_input2(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_input2(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NN_DATA_0) then
                    int_NN(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_NN(31 downto 0));
                end if;
            end if;
        end if;
    end process;
